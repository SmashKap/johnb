...
function tasman_setup() {
	 ...
	 */
	load_theme_textdomain( 'tasman', trailingslashit( WP_LANG_DIR ) . 'themes/' );
	load_theme_textdomain( 'tasman', get_stylesheet_directory() . '/languages' );
	load_theme_textdomain( 'tasman', get_template_directory() . '/languages' );
...
function tasman_scripts() {
	...
	$output = array(
		...
		'subNav' 		=> '<span class="screen-reader-text">' . __( 'Sub Navigation', 'tasman' ) . '</span>',
		'imageSrc'		=> __( 'Image Source &rarr;', 'tasman' )
	);
