...
function onetone_admin_footer_function() {
	...
	echo '<div class="onetone-admin-footer" style="height: 60px; display:none;background: rgba(0,0,0,0.5); position:fixed;bottom:0px;padding:15px 0;z-index:99;cursor: pointer;width: 100%;"><span style=" margin-left:180px; font-size:16px;color:#fff;">'.__('To save any changes on onetone options, click on the <strong  style="color:orange;">Save Options</strong> button on the right side.', 'onetone' ).'</span><button class="button-primary" id="onetone-save-options" style=" float:right;margin-right:50px;">'.__('Save Options', 'onetone' ).'</button></div>
...
function onetone_admin_notices(){
	...
	if( $dismiss != '1' )
		$notice  = '<div class="options-to-customise notice notice-error is-dismissible" style="display:block !important;">
	        <p>'.sprintf(__( 'Theme Options have been migrated to <a href="%s">customize</a>.', 'onetone' ), esc_url(admin_url('customize.php' )) ).'</p></div>';
		echo $notice;
}
...
function onetone_about_theme_callback() {
	...
	<p>'.$theme_info->get( 'Name' ).' is a one-page business theme based on Bootstrap framework and coded with HTML5/CSS3. All required information are displayed on a single page with clear order according to users\' preferences. The basic sections designed for business purpose have already been built for you, such as services, about, gallery, clients, etc. There\'s also an extensive admin panel where unlimited sections can be easily added. Multiple options are available if you prefer to do some adjustments, such as changing background, parallax scrolling background, video background, Font Awesome Icons, uploading logo and  favicon,adding custom CSS and so on. The theme is also responsive, clean, and SEO optimized. Please note that with our updation, interface of your blog can grow up with futher more diversities and the theme is compatible with Elementor Page Builder, WooCommerce, Polylang, Contact Form 7.</p>
	
	<div class="onetone-message blue">
	'.esc_attr__('Now you can just go to Customize to customize everything in your site.', 'onetone' ).'
	<p><a class="button" href="'.admin_url('customize.php').'"> '.esc_attr__('Customize', 'onetone' ).' </a></p>
	</div>
